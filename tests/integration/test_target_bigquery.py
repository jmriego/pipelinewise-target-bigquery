...
class TestIntegration(unittest.TestCase):
    ...
    def test_logical_streams_from_pg_with_append_only(self):
        """Tests logical streams from pg with inserts, updates and deletes"""
        tap_lines = test_utils.get_test_tap_lines('messages-pg-logical-streams.json')

        # Turning on append_only mode.
        self.config['append_only'] = True
        # Turning on hard delete mode which has no impact when append_only is on.
        self.config['hard_delete'] = True
        self.persist_lines(tap_lines)
        ...
        bigquery = DbSync(self.config)
        target_schema = self.config.get('default_target_schema', '')
        table_one = query(bigquery, "SELECT * FROM {}.logical1_table1 ORDER BY cid, _sdc_batched_at".format(target_schema))
        table_two = query(bigquery, "SELECT * FROM {}.logical1_table2 ORDER BY cid, _sdc_batched_at".format(target_schema))
        table_three = query(bigquery, "SELECT * FROM {}.logical2_table1 ORDER BY cid, _sdc_batched_at".format(target_schema))
        table_four = query(
            bigquery,
            "SELECT cid, ctimentz, ctimetz FROM {}.logical1_edgydata WHERE cid IN(1,2,3,4,5,6,8,9) ORDER BY cid, _sdc_batched_at".format(target_schema)
        )
        ...
        delete_time = datetime.datetime(2019, 10, 13, 14, 6, 31, 838328, tzinfo=timezone.utc)
        expected_table_two = [
            {'cid': 1, 'cvarchar': "inserted row", "_sdc_deleted_at": None},
            {'cid': 1, 'cvarchar': "updated row", "_sdc_deleted_at": None},
            {'cid': 2, 'cvarchar': "inserted row", "_sdc_deleted_at": None},
            {'cid': 2, 'cvarchar': 'updated row', "_sdc_deleted_at": None},
            {'cid': 3, 'cvarchar': "inserted row", "_sdc_deleted_at": None},
            {'cid': 3, 'cvarchar': "updated row", "_sdc_deleted_at": None},
            {'cid': 4, 'cvarchar': "delete later", "_sdc_deleted_at": None},
            {'cid': 4, 'cvarchar': None, "_sdc_deleted_at": delete_time},
            {'cid': 5, 'cvarchar': "inserted row", "_sdc_deleted_at": None},
            {'cid': 5, 'cvarchar': "updated row", "_sdc_deleted_at": None},
            {'cid': 6, 'cvarchar': "delete later", "_sdc_deleted_at": None},
            {'cid': 6, 'cvarchar': None, "_sdc_deleted_at": delete_time},
            {'cid': 7, 'cvarchar': "inserted row", "_sdc_deleted_at": None},
            {'cid': 7, 'cvarchar': "updated row", "_sdc_deleted_at": None},
            {'cid': 8, 'cvarchar': "inserted row", "_sdc_deleted_at": None},
            {'cid': 8, 'cvarchar': "updated row", "_sdc_deleted_at": None},
            {'cid': 9, 'cvarchar': "inserted row", "_sdc_deleted_at": None},
            {'cid': 9, 'cvarchar': "updated row", "_sdc_deleted_at": None},
            {'cid': 10, 'cvarchar': "inserted row", "_sdc_deleted_at": None},
            {'cid': 10, 'cvarchar': 'updated row', "_sdc_deleted_at": None},
            {'cid': 11, 'cvarchar': "inserted row", "_sdc_deleted_at": None},
            {"cid": 11, "cvarchar": None, "_sdc_deleted_at": delete_time},
            {'cid': 12, 'cvarchar': "inserted row", "_sdc_deleted_at": None},
            {"cid": 12, "cvarchar": None, "_sdc_deleted_at": delete_time},
            {'cid': 13, 'cvarchar': "inserted row", "_sdc_deleted_at": None},
            {"cid": 13, "cvarchar": None, "_sdc_deleted_at": delete_time},
            {'cid': 14, 'cvarchar': "inserted row", "_sdc_deleted_at": None},
            {"cid": 14, "cvarchar": None, "_sdc_deleted_at": delete_time},
            {'cid': 15, 'cvarchar': "inserted row", "_sdc_deleted_at": None},
            {"cid": 15, "cvarchar": None, "_sdc_deleted_at": delete_time},
            {'cid': 16, 'cvarchar': "inserted row", "_sdc_deleted_at": None},
            {"cid": 16, "cvarchar": None, "_sdc_deleted_at": delete_time},
            {'cid': 17, 'cvarchar': "inserted row", "_sdc_deleted_at": None},
            {"cid": 17, "cvarchar": None, "_sdc_deleted_at": delete_time},
            {'cid': 18, 'cvarchar': "inserted row", "_sdc_deleted_at": None},
            {"cid": 18, "cvarchar": None, "_sdc_deleted_at": delete_time},
            {'cid': 19, 'cvarchar': "inserted row", "_sdc_deleted_at": None},
            {"cid": 19, "cvarchar": None, "_sdc_deleted_at": delete_time},
            {'cid': 20, 'cvarchar': "inserted row", "_sdc_deleted_at": None},
            {"cid": 20, "cvarchar": None, "_sdc_deleted_at": delete_time},
        ]
        ...
        # ----------------------------------------------------------------------
        expected_table_three = [
            {'cid': 1, 'cvarchar': "inserted row"},
            {'cid': 1, 'cvarchar': "updated row"},
            {'cid': 2, 'cvarchar': "inserted row"},
            {'cid': 2, 'cvarchar': 'updated row'},
            {'cid': 3, 'cvarchar': "inserted row"},
            {'cid': 3, 'cvarchar': "updated row"},
        ]
